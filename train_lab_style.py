...
def grid_search(train_loader, val_loader):
    param_grid = {
        ...
        'learning_rate': [0.0001],  # Standard GAN learning rates
        'weight_decay': [1e-5, 1e-4, 1e-3],  # L2 regularization values
        'dropout_rate': [0.2, 0.4, 0.5],  # Dropout probabilities
        'num_epochs': [10]  # Training duration options
    }
...
if __name__ == "__main__":
    ...
    real_vs_fake_dir = os.path.join(dataset_dir, 'imp_vs_non-imp')
